...
# Define raw success metric before normalization
nfl_stats['RawSuccessMetric'] = (nfl_stats['nflYds_avg'] + nfl_stats['nflTD_avg'] +
                                  nfl_stats['nflRec_avg'] + nfl_stats['AP1_avg'] +
                                  nfl_stats['St_avg'] + nfl_stats['PB_avg'] +
                                  nfl_stats['wAV'])

# Standardize the SuccessMetric to match the feature range
nfl_stats['SuccessMetric'] = scaler.fit_transform(nfl_stats[['RawSuccessMetric']])
